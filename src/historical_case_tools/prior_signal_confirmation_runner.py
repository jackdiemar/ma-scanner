...
{markdown_table(baselines, ['case_id', 'ticker', 'company_name', 'acquisition_announcement_date', 'hit_status', 'confidence']) if baselines else 'None confirmed as no-hit yet because most targets lack exact acquisition dates or require manual EDGAR review.'}
