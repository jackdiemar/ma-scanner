...
def main():
    ...
    timing_analyzer = BuyTimingAnalyzer(fmp_client, finviz_scraper) if fmp_client.enabled else None
    ...
    output = {
        ...
        'results': {k: {
            ...
            'timing_status': v.get('timing_status', 'NO_DATA'),
            'timing_action': v.get('timing_action', ''),
            'timing_rationale': v.get('timing_rationale', []),
