...
RECIPIENT = get_env("SMTP_RECIPIENT", get_env("SMTP_USER"))
        ...
        <tr>
          ...
          <td style="vertical-align:middle;">
            <div style="font-size:18px;font-weight:700;color:{C['text_primary']};
                        letter-spacing:-0.3px;line-height:1.1;">{ticker}</div>
              ...
              <tr>
                <td style="text-align:center;">
                  <p style="font-size:10px;color:{C['text_tertiary']};
                    ...
                    Scoring: High ≥82 &nbsp;·&nbsp; Medium ≥72 &nbsp;·&nbsp; Watch ≥62<br>
                    Model: strategic pipeline &nbsp;·&nbsp; acquirability &nbsp;·&nbsp;
                    financial health &nbsp;·&nbsp; catalyst signals &nbsp;·&nbsp;
                    <strong style="color:#B8860B;">acquisition pattern match</strong><br>
                    Pattern engine: 14 confirmed 2023–2026 deals · 500-stock universe<br><br>
...
def load_latest_scan():
    import glob
    files = sorted(glob.glob(os.path.join(SCAN_DIR, 'scan_v11_*.json')))
    if not files:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='BSC M&A Scanner V11 — Email Alert')
